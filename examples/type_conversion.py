...
def main():
    ...
    print(f"  text_value: {TypedSettings.text_value!r} ({type(TypedSettings.text_value).__name__})")
    print(f"  integer_value: {TypedSettings.integer_value} ({type(TypedSettings.integer_value).__name__})")
    print(f"  float_value: {TypedSettings.float_value} ({type(TypedSettings.float_value).__name__})")
    print(f"  boolean_value: {TypedSettings.boolean_value} ({type(TypedSettings.boolean_value).__name__})")
    print(f"  string_list: {TypedSettings.string_list} ({type(TypedSettings.string_list).__name__})")
    print(f"  config_dict: {TypedSettings.config_dict} ({type(TypedSettings.config_dict).__name__})")
    print(f"  optional_string: {TypedSettings.optional_string} ({type(TypedSettings.optional_string).__name__})")
    print(f"  optional_float: {TypedSettings.optional_float} ({type(TypedSettings.optional_float).__name__})")
    ...
    print(f"  integer_value: {TypedSettings.integer_value} (converted from string '999')")
    print(f"  float_value: {TypedSettings.float_value} (converted from string '2.71828')")
    print(f"  boolean_value: {TypedSettings.boolean_value} (converted from string 'true')")
    ...
    for key in os.environ.copy():
        if key.startswith(("TEXT_", "INTEGER_", "FLOAT_", "BOOLEAN_",
                          "STRING_", "NUMBER_", "CONFIG_", "OPTIONAL_")):
            del os.environ[key]
